...
import { Store, User, Mail, Phone, Lock, MapPin, Globe, ChevronRight, CheckCircle, ArrowLeft } from "lucide-react";
...
const VendorSignup = () => {
    ...
    const categories = [
        ...
        "Home & Living", "Sports & Fitness", "Travel", "Entertainment", "Other"
    ];
    ...
    const handleSubmit = async (e) => {
        ...
        // Validation
        if (!form.ownerName.trim() || !form.brandName.trim() || !form.email.trim() || !form.password) {
                ...
                <div className="w-full max-w-md">
                    <div className="bg-gray-800/50 backdrop-blur-xl rounded-2xl border border-gray-700/50 p-8 text-center">
                        ...
                        <p className="text-gray-400 mb-6">
                            Your vendor account is pending admin approval. You will be notified once your account is activated.
                        </p>
                        <button
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 py-8 px-4">
            <div className="max-w-xl mx-auto">
                {/* Header */}
                <div className="mb-8">
                    <Link to="/vendor" className="inline-flex items-center text-gray-400 hover:text-white mb-4">
                    ...
                    <div className="flex items-center gap-3 mb-2">
                        ...
                        <div>
                            ...
                            <p className="text-gray-400 text-sm">Create your vendor account</p>
                        </div>
                    </div>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <p className="text-center text-sm text-gray-500">
                        ...
                        <Link to="/vendor" className="text-violet-400 hover:text-violet-300">
                            Login here
                        </Link>
                    </p>
                </form>
