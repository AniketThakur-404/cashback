    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-zinc-950 p-4 pb-24 md:pb-8 transition-colors duration-300">
            <div className="max-w-3xl mx-auto space-y-5">
                ...
                <div className="relative overflow-hidden rounded-2xl bg-gradient-to-r from-[#059669] to-[#5ab334] p-5 shadow-lg">
                    <div className="relative z-10 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="font-bold text-white text-base">Need Quick Help?</h3>
                                <p className="text-xs text-white/90 font-medium">Our team responds within 24 hours</p>
                            </div>
                        </div>
                    </div>
                    {/* Decorative */}
                ...
                <div className="space-y-3">
                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-[11px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Email Us</p>
                            <p className="text-sm font-semibold text-gray-900 dark:text-white truncate">support@assuredrewards.in</p>
                        </div>
                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-[11px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Call Us</p>
                            <p className="text-sm font-semibold text-gray-900 dark:text-white">+91 1800-123-4567</p>
                        </div>
                        <ChevronRight size={16} className="text-gray-300 dark:text-zinc-600 shrink-0" />
                    </a>
                    ...
                    <div className="flex items-center gap-4 rounded-2xl border border-gray-100 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-4 shadow-sm">
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-[11px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Visit Us</p>
                            <p className="text-sm font-semibold text-gray-900 dark:text-white">123 Business Park, Tech City, India 500001</p>
                        </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4 rounded-2xl border border-gray-100 dark:border-zinc-800 bg-white dark:bg-zinc-900 p-4 shadow-sm">
                        ...
                        <div className="flex-1 min-w-0">
                            <p className="text-[11px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-wider">Business Hours</p>
                            <p className="text-sm font-semibold text-gray-900 dark:text-white">Mon - Fri: 9:00 AM - 6:00 PM IST</p>
                        </div>
                ...
                <div className="bg-white dark:bg-zinc-900 rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-zinc-800">
                    <div className="flex items-center gap-2 mb-4">
                        ...
                        <h3 className="font-bold text-gray-900 dark:text-white">Send us a Message</h3>
                    </div>
                ...
                <div className="py-4 text-center">
                    <p className="text-[10px] text-gray-400 dark:text-gray-500">
                        <span className="text-primary font-bold">*</span> Powered by AssuredRewards | Secure & Trusted
                    </p>
                </div>
            </div>
        </div>
