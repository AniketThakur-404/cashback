        ...
        {!otpSent ? (
          <div className="space-y-3">
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 rounded-2xl border border-gray-100 dark:border-zinc-800/80 bg-white dark:bg-zinc-800/40 text-gray-700 dark:text-zinc-200 font-bold py-3.5 hover:bg-gray-50 dark:hover:bg-zinc-800/60 shadow-sm transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-50"
            >
