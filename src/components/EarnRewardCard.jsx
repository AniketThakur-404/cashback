...
const EarnRewardCard = ({ onLearnMore }) => {
    return (
        <div className="bg-gradient-to-br from-[#1a3d1a] via-[#1f4a1f] to-[#236d23] rounded-2xl p-8 border border-[#059669]/30 shadow-xl relative overflow-hidden">
            ...
            <div className="relative">
                <div className="flex items-start gap-4 mb-6">
                    <div className="w-12 h-12 bg-[#059669]/20 border border-[#059669]/30 rounded-lg flex items-center justify-center flex-shrink-0">
