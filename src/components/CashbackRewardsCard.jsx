...
const CashbackRewardsCard = ({
    ...
    return (
        <div className="bg-gradient-to-br from-[#1a3d1a] via-[#1f4a1f] to-[#1a3d1a] rounded-2xl p-6 border border-[#059669]/20 shadow-xl relative overflow-hidden">
            {/* Decorative elements */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-[#059669]/10 rounded-full blur-3xl" />
            <div className="absolute -bottom-8 -left-8 w-32 h-32 bg-[#059669]/10 rounded-full blur-3xl" />
            ...
            <div className="relative">
                ...
                <div className="mb-6">
                    <div className="flex items-center gap-2 mb-2">
                        <div className="w-8 h-8 bg-[#059669]/20 rounded flex items-center justify-center">
                            <span className="text-[#059669] font-bold">₦</span>
                        </div>
                        <div className="flex-1">
                            <div className="text-sm text-white/60">Available Cashback</div>
                        </div>
                        <button className="p-1.5 rounded-full bg-[#059669] hover:bg-[#047857] transition-colors">
